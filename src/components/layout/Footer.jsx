                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    ...
                    <div className="flex flex-col items-center md:items-end text-center md:text-right">
                        ...
                        <ul className="space-y-3 text-slate-300 text-sm w-full md:w-auto flex flex-col items-center md:items-end">
                            ...
                            {/* BLOC HORAIRES DYNAMIQUE */}
                            <li className="w-full max-w-[220px] mt-3 pt-3 border-t border-white/10">
                                {groupedHours.length > 0 ? groupedHours.map((group, index) => (
                                    <div key={index} className="flex justify-between md:justify-end md:gap-4 items-center py-1">
                                        ...
                                        {group.is_closed ? (
                                            ...
                                            <span className="font-bold text-white">{group.hours_text}</span>
                                        )}
                                    </div>
                                )) : (
                                    <div className="text-slate-500 italic text-right">Chargement...</div>
                                )}
                            </li>
                        </ul>
                    </div>
